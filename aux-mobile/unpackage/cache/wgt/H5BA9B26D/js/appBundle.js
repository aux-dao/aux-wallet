...
function convert_keydown(obj) {
    setTimeout(function () { convert_keyup(obj); }, 10);
}
var isMobileWeb = {
    Android: function () {
...
function cordovaFileError(errorCode) {
    var errorMessage = "";
    switch (errorCode) {
        case 1:
    ...
    var BigInteger = (function () {
        function BigInteger(value) {
            ...
            if (typeof value === "number") {
                ...
                if (parts.man.equals(GT.Uint64.Zero) || parts.exp <= -64)
                    return;
                if (parts.exp <= 0) {
        ...
        BigInteger.getDoubleParts = function (dbl) {
            ...
            var result = {
                sign: 1 - ((uu[1] >>> 30) & 2),
                man: new GT.Uint64(uu[0], uu[1] & 0x000FFFFF),
                exp: (uu[1] >>> 20) & 0x7FF,
                fFinite: true
            };
            if (result.exp == 0) {
                if (!result.man.equals(GT.Uint64.Zero))
                    result.exp = -1074;
            }
                ...
                result.man = result.man.or(new GT.Uint64(0, 0x00100000));
                result.exp -= 1075;
            }
            return result;
        };
...
(function (GT) {
    ...
    var Fixed8 = (function () {
        ...
        Object.defineProperty(Fixed8, "MaxValue", {
            get: function () { return _max || (_max = new Fixed8(new GT.Uint64(0xffffffff, 0x7fffffff))); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Fixed8, "MinusOne", {
            get: function () { return _minus || (_minus = new Fixed8(new GT.Uint64(0xffffffff, 0xffffffff))); },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Fixed8, "MinValue", {
            get: function () { return _min || (_min = new Fixed8(GT.Uint64.MinValue)); },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(Fixed8, "Satoshi", {
            get: function () { return _satoshi || (_satoshi = new Fixed8(new GT.Uint64(1))); },
            enumerable: true,
            configurable: true
        });
        ...
        Fixed8.fromNumber = function (value) {
            ...
            if (value >= 0x8000000000000000)
                throw new RangeError();
            var array = new Uint32Array((new GT.BigInteger(value)).toUint8Array(true, 8).buffer);
            return new Fixed8(new GT.Uint64(array[0], array[1]));
        };
        ...
        Fixed8.parse = function (str) {
            ...
            if (digits > 8)
                ...
                for (var i = digits; i < 8; i++)
                    str += '0';
            return new Fixed8(GT.Uint64.parse(str));
        };
...
(function (GT) {
    ...
    var Uint64 = (function (_super) {
        ...
        Uint64.parse = function (str) {
            var bi = GT.BigInteger.parse(str);
            if (bi.bitLength() > 64)
                throw new RangeError();
        ...
        Uint64.prototype.toString = function () {
            return (new GT.BigInteger(this._bits.buffer)).toString();
        };
        ...
        var Account = (function () {
            ...
            Account.create = function (privateKey) {
                ...
                if (privateKey.byteLength == 32)
                    account.publicKey = GT.Cryptography.ECPoint.multiply(GT.Cryptography.ECCurve.secp256r1.G, privateKey);
                else
                    account.publicKey = GT.Cryptography.ECPoint.fromUint8Array(privateKey, GT.Cryptography.ECCurve.secp256r1);
            ...
            Account.prototype.export = function () {
                ...
                data[33] = 0x01;
                return window.crypto.subtle.digest({ name: "SHA-256" }, new Uint8Array(data.buffer, 0, data.byteLength - 4)).then(function (result) {
            ...
            Object.defineProperty(Coin.prototype, "state", {
                ...
                set: function (value) {
                    if (this._state != value) {
                        this._state = value;
                        if (this.trackState == GT.IO.Caching.TrackState.None)
                            this.trackState = GT.IO.Caching.TrackState.Changed;
                    }
                },
                enumerable: true,
                configurable: true
...
(function (GT) {
    ...
    (function (Wallets) {
        ...
        })(CoinState = Wallets.CoinState || (Wallets.CoinState = {}));
    })(Wallets = GT.Wallets || (GT.Wallets = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    ...
    (function (Wallets) {
        var Contract = (function () {
            ...
            Contract.createMultiSigContract = function (publicKeyHash, m, publicKeys) {
                var redeemScript = Contract.createMultiSigRedeemScript(m, publicKeys);
                var parameterList = GT.Linq.Enumerator.repeat(Wallets.ContractParameterType.Signature, m).toArray();
                return Contract.create(publicKeyHash, parameterList, redeemScript);
            };
            Contract.createMultiSigRedeemScript = function (m, publicKeys) {
                if (!(1 <= m && m <= publicKeys.length && publicKeys.length <= 1024))
                    throw new RangeError();
                publicKeys.sort(function (a, b) { return a.compareTo(b); });
                var sb = new GT.Core.Scripts.ScriptBuilder();
                sb.push(m);
...
(function (GT) {
    ...
    (function (Wallets) {
        ...
        })(ContractParameterType = Wallets.ContractParameterType || (Wallets.ContractParameterType = {}));
    })(Wallets = GT.Wallets || (GT.Wallets = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    ...
    (function (Wallets) {
        var Wallet = (function () {
            ...
            Object.defineProperty(Wallet.prototype, "isWalletRunning", {
            ...
            Wallet.prototype.changePassword = function (password_old, password_new) {
                var _this = this;
                var passwordKey;
                var passwordKeyHash;
                return Promise.all([
                    this.loadStoredData("PasswordHash"),
                    password_old.toAesKey().then(function (result) {
                        return window.crypto.subtle.digest({ name: "SHA-256" }, result);
                    })
                ]).then(function (results) {
                    if (results[0].byteLength != results[1].byteLength)
                        throw new Error();
                    var x = new Uint8Array(results[0]), y = new Uint8Array(results[1]);
                    for (var i = 0; i < x.length; i++)
                        if (x[i] != y[i])
                            throw new Error();
                    ...
                    return Promise.all([
                        ...
                        window.crypto.subtle.importKey("raw", result, { name: "AES-CBC" }, false, ["encrypt"])
                    ]);
                }).then(function (results) {
                    passwordKeyHash = results[0];
                    return window.crypto.subtle.encrypt({ name: "AES-CBC", iv: _this.iv }, results[1], _this.masterKey);
                }).then(function (result) {
                    return Promise.all([
            ...
            Wallet.prototype.containsAccount = function () {
                var _this = this;
                if (arguments[0] instanceof GT.Cryptography.ECPoint) {
            ...
            Wallet.prototype.decryptPrivateKey = function (encryptedPrivateKey) {
                ...
                if (encryptedPrivateKey.byteLength != 112)
                    throw new RangeError();
                return window.crypto.subtle.importKey("raw", this.masterKey, { name: "AES-CBC" }, false, ["decrypt"]).then(function (result) {
            ...
            Wallet.prototype.encryptPrivateKey = function (decryptedPrivateKey) {
                var _this = this;
                return window.crypto.subtle.importKey("raw", this.masterKey, { name: "AES-CBC" }, false, ["encrypt"]).then(function (result) {
            ...
            Wallet.findUnspentCoins = function (unspents, asset_id, amount) {
                var unspents_asset = linq(unspents).where(function (p) { return p.assetId.equals(asset_id); }).toArray();
                var sum = GT.Fixed8.Zero;
                for (var i_3 = 0; i_3 < unspents_asset.length; i_3++)
                    sum = sum.add(unspents_asset[i_3].value);
                if (sum.compareTo(amount) < 0)
                    return null;
                if (sum.equals(amount))
                    return unspents_asset;
                var unspents_ordered = linq(unspents_asset).orderByDescending(function (p) { return p.value; }).toArray();
                var i = 0;
                while (unspents_ordered[i].value.compareTo(amount) <= 0)
                    amount = amount.subtract(unspents_ordered[i++].value);
                if (amount.equals(GT.Fixed8.Zero))
                    return linq(unspents_ordered).take(i).toArray();
                else
                    return linq(unspents_ordered).take(i).concat(linq([linq(unspents_ordered).last(function (p) { return p.value.compareTo(amount) >= 0; })])).toArray();
            };
            ...
            Wallet.prototype.getUnclaimedCoins = function () {
                var array = new Array();
                this.coins.forEach(function (coin) {
                    if (coin.state == Wallets.CoinState.Spent && coin.assetId.equals(GT.Core.Blockchain.AntShare.hash))
                        array.push(coin);
                });
                return array;
            };
            ...
            Wallet.prototype.init = function (path, password, create) {
                ...
                return Promise.resolve(typeof password === "string" ? password.toAesKey() : password).then(function (result) {
                    ...
                    if (create) {
                        ...
                        _this.coins = new GT.IO.Caching.TrackableCollection();
                        return Promise.resolve(GT.Core.Blockchain.Default == null ? 0 : GT.Core.Blockchain.Default.getBlockCount()).then(function (result) {
                        ...
                        return Promise.all([
                            ...
                            return _this.loadStoredData("MasterKey");
                        }).then(function (result) {
                            return window.crypto.subtle.decrypt({ name: "AES-CBC", iv: _this.iv }, aesKey, result);
                        }).then(function (result) {
                            _this.masterKey = new Uint8Array(result);
                            return Promise.all([
                                _this.loadAccounts(),
                                _this.loadContracts(),
                                _this.loadCoins(),
                            ...
                            for (var i = 0; i < results[0].length; i++)
                                _this.accounts.set(results[0][i].publicKeyHash.toString(), results[0][i]);
                            for (var i = 0; i < results[1].length; i++)
                                _this.contracts.set(results[1][i].scriptHash.toString(), results[1][i]);
                            _this.coins = new GT.IO.Caching.TrackableCollection(results[2]);
                            _this.current_height = (new Uint32Array(results[3]))[0];
                        });
                    }
                }).then(function () {
                });
            ...
            Wallet.prototype.makeTransaction = function (tx, fee) {
                ...
                var outputs = tx instanceof GT.Core.IssueTransaction ? new Array() : tx.outputs;
                ...
                if (fee.compareTo(GT.Fixed8.Zero) > 0) {
                    var key = GT.Core.Blockchain.AntCoin.hash.toString();
                    if (pay_total.has(key)) {
                        var item = pay_total.get(key);
                        item.value = item.value.add(fee);
                    }
                    else {
                        pay_total.set(key, { assetId: GT.Core.Blockchain.AntCoin.hash, value: fee });
                    }
                }
                ...
                for (var i = 0; i < input_sum.length; i++) {
                    ...
                    if (input_sum[i].value.compareTo(pay_total.get(key).value) > 0) {
                        var output = new GT.Core.TransactionOutput();
            ...
            Wallet.prototype.processBlocks = function () {
                ...
                Promise.resolve(GT.Core.Blockchain.Default == null ? 0 : GT.Core.Blockchain.Default.getBlockCount()).then(function (result) {
                    var block_height = result;
                    if (_this.current_height >= block_height)
                        return GT.Core.Blockchain.SecondsPerBlock;
                    return GT.Core.Blockchain.Default.getBlock(_this.current_height).then(function (result) {
                        if (result == null)
                            return 0;
                        return _this.processNewBlock(result).then(function () {
                            return _this.current_height < block_height ? 0 : GT.Core.Blockchain.SecondsPerBlock;
                        });
                    });
                }).then(function (result) {
                    if (_this.isrunning)
                    ...
                    setTimeout(_this.processBlocks.bind(_this), GT.Global.reConnectMultiplier * 1000);
            ...
            Wallet.prototype.processNewBlock = function (block) {
                ...
                return Promise.all(promises).then(function () {
                    ...
                    for (var i = 0; i < block.transactions.length; i++) {
                        ...
                        for (var index = 0; index < tx.outputs.length; index++) {
                            ...
                            if (_this.contracts.has(output.scriptHash.toString())) {
                                var input = new GT.Core.TransactionInput();
                    ...
                    for (var i = 0; i < block.transactions.length; i++) {
                        ...
                        for (var j = 0; j < inputs.length; j++) {
                            ...
                            if (_this.coins.has(inputKey)) {
                                if (_this.coins.get(inputKey).assetId.equals(GT.Core.Blockchain.AntShare.hash))
                    ...
                    for (var i = 0; i < block.transactions.length; i++) {
                        if (block.transactions[i].type != GT.Core.TransactionType.ClaimTransaction)
                            continue;
                        var tx = block.transactions[i];
                    ...
                    for (var i = 0; i < changeset.length; i++) {
                        if (changeset[i].trackState == GT.IO.Caching.TrackState.Added)
                            added.push(changeset[i]);
                        else if (changeset[i].trackState == GT.IO.Caching.TrackState.Changed)
                            changed.push(changeset[i]);
                        else if (changeset[i].trackState == GT.IO.Caching.TrackState.Deleted)
            ...
            Wallet.prototype.saveTransaction = function (tx) {
                var _this = this;
                var inputs = tx.getAllInputs();
                ...
                return tx.ensureHash().then(function () {
                    ...
                    for (var i = 0; i < tx.outputs.length; i++) {
                        if (_this.contracts.has(tx.outputs[i].scriptHash.toString())) {
                            var coin = new Wallets.Coin();
                            coin.input = new GT.Core.TransactionInput();
                    ...
                    return _this.onSaveTransaction(tx, added, changed).then(function () {
                        _this.coins.commit();
                        _this.balanceChanged.dispatchEvent(null);
                        return true;
                    });
            ...
            Wallet.prototype.signInternal = function (signable, account) {
                ...
                return window.crypto.subtle.importKey("jwk", { kty: "EC", crv: "P-256", d: d, x: x, y: y, ext: true }, { name: "ECDSA", namedCurve: "P-256" }, false, ["sign"]).then(function (result) {
                    var ms = new GT.IO.MemoryStream();
                    var writer = new GT.IO.BinaryWriter(ms);
                    signable.serializeUnsigned(writer);
                    return window.crypto.subtle.sign({ name: "ECDSA", hash: { name: "SHA-256" } }, result, ms.toArray());
                });
            };
            ...
            Wallet.toScriptHash = function (address) {
                ...
                return window.crypto.subtle.digest({ name: "SHA-256" }, new Uint8Array(data.buffer, 0, data.length - 4)).then(function (result) {
                    ...
                    return new GT.Uint160(array.buffer);
                });
            };
            return Wallet;
        }());
    ...
    (function (Network) {
        var Inventory = (function () {
            ...
            Inventory.prototype.ensureHash = function () {
                ...
                return window.crypto.subtle.digest({ name: "SHA-256" }, this.getHashData()).then(function (result) {
                    return window.crypto.subtle.digest({ name: "SHA-256" }, result);
                }).then(function (result) {
                    return _this.hash = new GT.Uint256(result);
                });
            };
            Inventory.prototype.getHashData = function () {
                var ms = new GT.IO.MemoryStream();
                var w = new GT.IO.BinaryWriter(ms);
...
(function (GT) {
    ...
    (function (Network) {
        var RemoteNode = (function () {
            function RemoteNode(rpc) {
                this.rpc = rpc;
            }
            RemoteNode.prototype.relay = function (inventory) {
                return this.rpc.call("sendrawtransaction", [Uint8Array.fromSerializable(inventory).toHexString()]);
            };
            return RemoteNode;
        }());
        Network.RemoteNode = RemoteNode;
    })(Network = GT.Network || (GT.Network = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    ...
    (function (Network) {
        ...
        (function (RPC) {
            var RpcClient = (function () {
                ...
                Object.defineProperty(RpcClient.prototype, "Url", {
...
(function (GT) {
    ...
    (function (Network) {
        var REST;
        (function (REST) {
            var RestClient2 = (function () {
                function RestClient2(url) {
                    this.rootURL = url;
                }
                RestClient2.prototype.handleResponse = function (response) {
                ...
                RestClient2.prototype.get = function (url) {
                    var _this = this;
                    return new Promise(function (resolve, reject) {
                        return fetch(url, { method: 'GET' }).then(_this.handleResponse).then(function (result) {
                ...
                RestClient2.prototype.post = function (url, data) {
                    var _this = this;
                    return new Promise(function (resolve, reject) {
                        return fetch(url, {
                            method: 'POST',
                            ...
                            body: data
                        }).then(_this.handleResponse).then(function (result) {
                            return resolve(result);
                        }).catch(function (error) {
                            return reject(error);
                        });
            ...
            REST.RestClient2 = RestClient2;
        })(REST = Network.REST || (Network.REST = {}));
    })(Network = GT.Network || (GT.Network = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    ...
    (function (Network) {
        var REST;
        (function (REST) {
            var SPVClient = (function (_super) {
                __extends(SPVClient, _super);
                function SPVClient(url) {
                    return _super.call(this, url) || this;
                }
                SPVClient.prototype.getHeight = function () {
                    var url = this.rootURL + "/api/height" + "?r=" + Math.random();
                    return this.get(url);
                };
                SPVClient.prototype.getBizHeights = function (BizID) {
                    var url = this.rootURL + "/api/Bizheight" + "?BizID=" + BizID + "&r=" + Math.random();
                    return this.get(url);
                };
                SPVClient.prototype.getBlock = function (height) {
                    var url = this.rootURL + "/api/block/" + height + "?r=" + Math.random();
                    return this.get(url);
                };
                SPVClient.prototype.getTx = function (txid) {
                    var url = this.rootURL + "/api/transaction/" + txid + "?r=" + Math.random();
                    return this.get(url);
                };
                SPVClient.prototype.getAddr = function (addr) {
                    var url = this.rootURL + "/api/address/" + addr + "?r=" + Math.random();
                    return this.get(url);
                };
                SPVClient.prototype.postOnTransfer = function (source, dests, amounts, assetId) {
                    var url = this.rootURL + "/api/transfer";
                    var params = [];
                ...
                SPVClient.prototype.postBroadcast = function (pubKey, signature, tx) {
                    var url = this.rootURL + "/api/broadcast";
                    var params = [];
                ...
                SPVClient.prototype.getGas = function (addr) {
                    var url = this.rootURL + "/api/claim/" + addr + "?r=" + Math.random();
                    return this.get(url);
                };
                SPVClient.prototype.claimGas = function (pubKey) {
                    var url = this.rootURL + "/api/gas" + "?r=" + Math.random();
                    var params = [];
                    params.push("publicKey" + "=" + pubKey);
                    var dataToSend = params.join("&");
                    return this.post(url, dataToSend);
...
(function (GT) {
    ...
    (function (Linq) {
        var Enumerator = (function () {
            ...
            Enumerator.prototype.aggregate = function (seed, func) {
                this.reset();
                while (this.next())
                    seed = func(seed, this.value());
                return seed;
            };
            Enumerator.prototype.all = function (predicate) {
                this.reset();
                while (this.next())
            ...
            Enumerator.prototype.any = function (predicate) {
                if (predicate === void 0) { predicate = Enumerator.defaultPredicate; }
                this.reset();
                while (this.next())
                    if (predicate(this.value()))
                        return true;
            ...
            Enumerator.prototype.average = function (selector) {
                if (selector === void 0) { selector = function (p) { return p; }; }
                this.reset();
                var sum = 0;
                var count = 0;
                while (this.next()) {
            ...
            Enumerator.prototype.concat = function (second) {
                return new Linq.ConcatEnumerator(new Linq.ArrayEnumerator([this, second]));
            };
            Enumerator.prototype.contains = function (value, comparer) {
                if (comparer === void 0) { comparer = Enumerator.defaultEqualityComparer; }
                this.reset();
                while (this.next())
            ...
            Enumerator.prototype.count = function (predicate) {
                if (predicate === void 0) { predicate = Enumerator.defaultPredicate; }
                this.reset();
                var n = 0;
                while (this.next())
            ...
            Enumerator.defaultAddition = function (a, b) {
                if (a.add)
                    return a.add(b);
                else
                    return a + b;
            };
            Enumerator.defaultComparer = function (a, b) {
                if (a.compareTo)
                    return a.compareTo(b);
                else
                    return a - b;
            };
            Enumerator.defaultEqualityComparer = function (a, b) {
                if (a.equals)
                    return a.equals(b);
                else
                    return a === b;
            };
            Enumerator.defaultPredicate = function (p) {
                return true;
            };
            Enumerator.prototype.distinct = function (comparer) {
                if (comparer === void 0) { comparer = Enumerator.defaultEqualityComparer; }
                return new Linq.DistinctEnumerator(this, comparer);
            };
            Enumerator.prototype.elementAt = function (index) {
                this.reset();
            ...
            Enumerator.prototype.elementAtOrDefault = function (index, defaultValue) {
                this.reset();
                for (var i = 0; i <= index; i++)
                    if (!this.next())
                        return defaultValue;
            ...
            Enumerator.empty = function () {
                return new Linq.ArrayEnumerator([]);
            };
            Enumerator.prototype.except = function (second, comparer) {
                if (comparer === void 0) { comparer = Enumerator.defaultEqualityComparer; }
                return new Linq.ExceptEnumerator(this, second, comparer);
            };
            Enumerator.prototype.first = function (predicate) {
                if (predicate === void 0) { predicate = Enumerator.defaultPredicate; }
                this.reset();
                while (this.next()) {
            ...
            Enumerator.prototype.firstOrDefault = function (predicate, defaultValue) {
                this.reset();
                while (this.next()) {
                    var value = this.value();
                    if (predicate(value))
            ...
            Enumerator.prototype.groupBy = function (keySelector, resultSelector, comparer) {
                if (comparer === void 0) { comparer = Enumerator.defaultEqualityComparer; }
                return new Linq.GroupByEnumerator(this, keySelector, resultSelector, comparer);
            };
            Enumerator.prototype.intersect = function (second, comparer) {
                if (comparer === void 0) { comparer = Enumerator.defaultEqualityComparer; }
                return new Linq.IntersectEnumerator(this, second, comparer);
            };
            Enumerator.prototype.last = function (predicate) {
                if (predicate === void 0) { predicate = Enumerator.defaultPredicate; }
                this.reset();
                var last;
                var found = false;
            ...
            Enumerator.prototype.lastOrDefault = function (predicate, defaultValue) {
                this.reset();
                while (this.next()) {
                    var value = this.value();
                    if (predicate(value))
            ...
            Enumerator.prototype.max = function (selector) {
                this.reset();
                var max;
                var count = 0;
                while (this.next()) {
                    var value = selector ? selector(this.value()) : this.value();
            ...
            Enumerator.prototype.min = function (selector) {
                this.reset();
                var min;
                var count = 0;
                while (this.next()) {
            ...
            Enumerator.prototype.orderBy = function (keySelector, comparer) {
                if (keySelector === void 0) { keySelector = function (p) { return p; }; }
                if (comparer === void 0) { comparer = Enumerator.defaultComparer; }
                return new Linq.OrderByEnumerator(this, keySelector, comparer);
            };
            Enumerator.prototype.orderByDescending = function (keySelector, comparer) {
                if (keySelector === void 0) { keySelector = function (p) { return p; }; }
                if (comparer === void 0) { comparer = Enumerator.defaultComparer; }
                return new Linq.OrderByEnumerator(this, keySelector, function (a, b) { return -comparer(a, b); });
            };
            Enumerator.range = function (start, count) {
                var array = new Array();
                for (var i = 0; i < count; i++)
                    array.push(i + start);
                return new Linq.ArrayEnumerator(array);
            };
            Enumerator.repeat = function (element, count) {
                var array = new Array(count);
                array.fill(element);
                return new Linq.ArrayEnumerator(array);
            };
            Enumerator.prototype.reverse = function () {
                return new Linq.ReverseEnumerator(this);
            };
            Enumerator.prototype.select = function (selector) {
                return new Linq.SelectEnumerator(this, selector);
            };
            Enumerator.prototype.selectMany = function (selector) {
                return new Linq.ConcatEnumerator(this.select(selector));
            };
            Enumerator.prototype.sequenceEqual = function (second, comparer) {
                if (comparer === void 0) { comparer = Enumerator.defaultEqualityComparer; }
                this.reset();
                second.reset();
                while (true) {
            ...
            Enumerator.prototype.single = function (predicate) {
                if (predicate === void 0) { predicate = Enumerator.defaultPredicate; }
                this.reset();
                var single;
                var found = false;
            ...
            Enumerator.prototype.singleOrDefault = function (predicate, defaultValue) {
                this.reset();
                var single;
                var found = false;
                while (this.next()) {
            ...
            Enumerator.prototype.skip = function (count) {
                return this.skipWhile(function (p, i) { return i < count; });
            };
            Enumerator.prototype.skipWhile = function (predicate) {
                return new Linq.SkipWhileEnumerator(this, predicate);
            };
            Enumerator.prototype.sum = function (selector) {
                this.reset();
                var sum = 0;
                while (this.next())
                    sum += selector(this.value());
            ...
            Enumerator.prototype.take = function (count) {
                return this.takeWhile(function (p, i) { return i < count; });
            };
            Enumerator.prototype.takeWhile = function (predicate) {
                return new Linq.TakeWhileEnumerator(this, predicate);
            };
            ...
            Enumerator.prototype.union = function (second, comparer) {
                if (comparer === void 0) { comparer = Enumerator.defaultEqualityComparer; }
                return this.concat(second).distinct(comparer);
            };
            Enumerator.prototype.where = function (predicate) {
                return new Linq.WhereEnumerator(this, predicate);
            };
            return Enumerator;
        }());
        Linq.Enumerator = Enumerator;
    })(Linq = GT.Linq || (GT.Linq = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    var Linq;
    (function (Linq) {
        var ArrayEnumerator = (function (_super) {
            ...
            ArrayEnumerator.prototype.any = function (predicate) {
                if (predicate == null)
                    return this.array.length > 0;
                else
                    return _super.prototype.any.call(this, predicate);
            };
            ArrayEnumerator.prototype.count = function (predicate) {
                if (predicate == null)
                    return this.array.length;
                else
                    return _super.prototype.count.call(this, predicate);
            };
            ArrayEnumerator.prototype.elementAt = function (index) {
                if (index >= this.array.length)
                    throw new RangeError();
                else
                    return this.array[index];
            };
            ArrayEnumerator.prototype.elementAtOrDefault = function (index, defaultValue) {
                if (index >= this.array.length)
                    return defaultValue;
                else
                    return this.array[index];
            };
            ArrayEnumerator.prototype.first = function (predicate) {
                if (predicate == null)
                    return this.array[0];
                else
                    return _super.prototype.first.call(this, predicate);
            };
            ArrayEnumerator.prototype.last = function (predicate) {
                if (predicate == null) {
            ...
            ArrayEnumerator.prototype.lastOrDefault = function (predicate, defaultValue) {
                for (var i = this.array.length - 1; i >= 0; i--)
                    if (predicate(this.array[i]))
                        return this.array[i];
                return defaultValue;
            ...
            ArrayEnumerator.prototype.single = function (predicate) {
                if (predicate == null) {
                    ...
                    return _super.prototype.single.call(this, predicate);
                }
            };
            ArrayEnumerator.prototype.value = function () {
...
(function (GT) {
    var Linq;
    (function (Linq) {
        var ConcatEnumerator = (function (_super) {
            __extends(ConcatEnumerator, _super);
            function ConcatEnumerator(enumerators) {
                var _this = _super.call(this) || this;
                _this.enumerators = enumerators;
                return _this;
            }
            ConcatEnumerator.prototype.next = function () {
            ...
            ConcatEnumerator.prototype.nextEnumerator = function () {
            ...
            ConcatEnumerator.prototype.value = function () {
                return this.enumerator.value();
            };
            return ConcatEnumerator;
        }(Linq.Enumerator));
        Linq.ConcatEnumerator = ConcatEnumerator;
    })(Linq = GT.Linq || (GT.Linq = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    var Linq;
    (function (Linq) {
        var DistinctEnumerator = (function (_super) {
            __extends(DistinctEnumerator, _super);
            function DistinctEnumerator(enumerator, comparer) {
                var _this = _super.call(this) || this;
                _this.enumerator = enumerator;
            ...
            DistinctEnumerator.prototype.value = function () {
                return this.enumerator.value();
            };
            return DistinctEnumerator;
        }(Linq.Enumerator));
        Linq.DistinctEnumerator = DistinctEnumerator;
    })(Linq = GT.Linq || (GT.Linq = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    var Linq;
    (function (Linq) {
        var ExceptEnumerator = (function (_super) {
            __extends(ExceptEnumerator, _super);
            function ExceptEnumerator(e1, e2, comparer) {
                var _this = _super.call(this) || this;
                _this.e1 = e1;
                _this.e2 = e2;
                _this.comparer = comparer;
            ...
            ExceptEnumerator.prototype.value = function () {
                return this.e1.value();
            };
            return ExceptEnumerator;
        }(Linq.Enumerator));
        Linq.ExceptEnumerator = ExceptEnumerator;
    })(Linq = GT.Linq || (GT.Linq = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    var Linq;
    (function (Linq) {
        var GroupByEnumerator = (function (_super) {
            __extends(GroupByEnumerator, _super);
            function GroupByEnumerator(source, keySelector, resultSelector, comparer) {
                var _this = _super.call(this) || this;
                _this.source = source;
            ...
            GroupByEnumerator.prototype.next = function () {
                if (this.enumerator == null) {
                    ...
                    for (var i = 0; i < groups.length; i++)
                        results.push(this.resultSelector(groups[i].key, new Linq.ArrayEnumerator(groups[i].group)));
                    this.enumerator = new Linq.ArrayEnumerator(results);
                }
                return this.enumerator.next();
            };
            GroupByEnumerator.prototype.reset = function () {
                this.enumerator = null;
                this.source.reset();
            };
            GroupByEnumerator.prototype.value = function () {
                return this.enumerator.value();
            };
            return GroupByEnumerator;
        }(Linq.Enumerator));
        Linq.GroupByEnumerator = GroupByEnumerator;
    })(Linq = GT.Linq || (GT.Linq = {}));
})(GT || (GT = {}));
function linq(array) {
    return new GT.Linq.ArrayEnumerator(array);
}
var GT;
(function (GT) {
    var Linq;
    (function (Linq) {
        var IntersectEnumerator = (function (_super) {
            __extends(IntersectEnumerator, _super);
            function IntersectEnumerator(e1, e2, comparer) {
                var _this = _super.call(this) || this;
                _this.e1 = e1;
                _this.e2 = e2;
                _this.comparer = comparer;
            ...
            IntersectEnumerator.prototype.value = function () {
                return this.e1.value();
            };
            return IntersectEnumerator;
        }(Linq.Enumerator));
        Linq.IntersectEnumerator = IntersectEnumerator;
    })(Linq = GT.Linq || (GT.Linq = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    var Linq;
    (function (Linq) {
        var OrderByEnumerator = (function (_super) {
            __extends(OrderByEnumerator, _super);
            function OrderByEnumerator(enumerator, keySelector, comparer) {
                var _this = _super.call(this) || this;
                _this.enumerator = enumerator;
                _this.keySelector = keySelector;
                _this.comparer = comparer;
            ...
            OrderByEnumerator.prototype.next = function () {
                var _this = this;
                if (this.arrayEnumerator == null)
                    this.arrayEnumerator = new Linq.ArrayEnumerator(this.enumerator.toArray().sort(function (a, b) { return _this.comparer(_this.keySelector(a), _this.keySelector(b)); }));
                return this.arrayEnumerator.next();
            };
            OrderByEnumerator.prototype.reset = function () {
                this.arrayEnumerator = null;
            };
            OrderByEnumerator.prototype.value = function () {
                return this.arrayEnumerator.value();
            };
            return OrderByEnumerator;
        }(Linq.Enumerator));
        Linq.OrderByEnumerator = OrderByEnumerator;
    })(Linq = GT.Linq || (GT.Linq = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    var Linq;
    (function (Linq) {
        var ReverseEnumerator = (function (_super) {
            __extends(ReverseEnumerator, _super);
            function ReverseEnumerator(enumerator) {
                var _this = _super.call(this) || this;
                _this.enumerator = enumerator;
                return _this;
            }
            ReverseEnumerator.prototype.next = function () {
                if (this.arrayEnumerator == null) {
                    ...
                    this.arrayEnumerator = new Linq.ArrayEnumerator(array);
                }
                return this.arrayEnumerator.next();
            };
            ...
            ReverseEnumerator.prototype.value = function () {
                return this.arrayEnumerator.value();
            };
            return ReverseEnumerator;
        }(Linq.Enumerator));
        Linq.ReverseEnumerator = ReverseEnumerator;
    })(Linq = GT.Linq || (GT.Linq = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    var Linq;
    (function (Linq) {
        var SelectEnumerator = (function (_super) {
            __extends(SelectEnumerator, _super);
            function SelectEnumerator(enumerator, selector) {
                var _this = _super.call(this) || this;
                _this.enumerator = enumerator;
            ...
            SelectEnumerator.prototype.next = function () {
                var b = this.enumerator.next();
                if (b)
                    this.index++;
                return b;
            };
            ...
            SelectEnumerator.prototype.value = function () {
                return this.selector(this.enumerator.value(), this.index);
            };
            return SelectEnumerator;
        }(Linq.Enumerator));
        Linq.SelectEnumerator = SelectEnumerator;
    })(Linq = GT.Linq || (GT.Linq = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    var Linq;
    (function (Linq) {
        var SkipWhileEnumerator = (function (_super) {
            __extends(SkipWhileEnumerator, _super);
            function SkipWhileEnumerator(enumerator, predicate) {
                var _this = _super.call(this) || this;
                _this.enumerator = enumerator;
            ...
            SkipWhileEnumerator.prototype.next = function () {
                if (!this.skipped) {
                    var index = 0;
                    while (this.enumerator.next())
            ...
            SkipWhileEnumerator.prototype.value = function () {
                return this.enumerator.value();
            };
            return SkipWhileEnumerator;
        }(Linq.Enumerator));
        Linq.SkipWhileEnumerator = SkipWhileEnumerator;
    })(Linq = GT.Linq || (GT.Linq = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    var Linq;
    (function (Linq) {
        var TakeWhileEnumerator = (function (_super) {
            __extends(TakeWhileEnumerator, _super);
            function TakeWhileEnumerator(enumerator, predicate) {
                var _this = _super.call(this) || this;
                _this.enumerator = enumerator;
                _this.predicate = predicate;
            ...
            TakeWhileEnumerator.prototype.next = function () {
                if (this.finished)
                    return false;
                if (!this.enumerator.next())
                    return false;
            ...
            TakeWhileEnumerator.prototype.value = function () {
                return this.enumerator.value();
            };
            return TakeWhileEnumerator;
        }(Linq.Enumerator));
        Linq.TakeWhileEnumerator = TakeWhileEnumerator;
    })(Linq = GT.Linq || (GT.Linq = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    var Linq;
    (function (Linq) {
        var WhereEnumerator = (function (_super) {
            __extends(WhereEnumerator, _super);
            function WhereEnumerator(enumerator, predicate) {
                var _this = _super.call(this) || this;
                _this.enumerator = enumerator;
                _this.predicate = predicate;
                _this.index = 0;
            ...
            WhereEnumerator.prototype.next = function () {
                while (this.enumerator.next())
                    if (this.predicate(this.enumerator.value(), this.index++))
                        return true;
                return false;
            ...
            WhereEnumerator.prototype.value = function () {
                return this.enumerator.value();
            };
            return WhereEnumerator;
        }(Linq.Enumerator));
        Linq.WhereEnumerator = WhereEnumerator;
    })(Linq = GT.Linq || (GT.Linq = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    ...
    (function (IO) {
        var BinaryReader = (function () {
            ...
            BinaryReader.prototype.readFixed8 = function () {
                return new GT.Fixed8(this.readUint64());
            };
            ...
            BinaryReader.prototype.readUint160 = function () {
                return new GT.Uint160(this.readBytes(20));
            };
            BinaryReader.prototype.readUint256 = function () {
                return new GT.Uint256(this.readBytes(32));
            };
            ...
            BinaryReader.prototype.readUint64 = function () {
                ...
                if (this.array_uint32 == null)
                    this.array_uint32 = new Uint32Array(this._buffer, 0, 2);
                return new GT.Uint64(this.array_uint32[0], this.array_uint32[1]);
            };
...
Uint8Array.prototype.asSerializable = function (T) {
    var ms = new GT.IO.MemoryStream(this.buffer, false);
    var reader = new GT.IO.BinaryReader(ms);
...
(function (GT) {
        ...
        (function (Wallets) {
            ...
            (function (IndexedDB) {
                var DbContext = (function () {
                    ...
                    DbContext.prototype.close = function () {
                        this.db.close();
                    };
                    DbContext.delete = function (name) {
                    ...
                    DbContext.prototype.open = function (version) {
                        var _this = this;
                    ...
                    DbContext.promise = function (request) {
                        return new Promise(function (resolve, reject) {
    ...
    })(Implementations = GT.Implementations || (GT.Implementations = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    var Implementations;
            ...
            (function (IndexedDB) {
                var IndexedDBWallet = (function (_super) {
                    ...
                    function IndexedDBWallet(name) {
                        var _this = _super.call(this) || this;
                        _this.db = new IndexedDB.WalletDataContext(name);
                        return _this;
                    }
                    IndexedDBWallet.prototype.addContract = function (contract) {
                        ...
                        return _super.prototype.addContract.call(this, contract).then(function () {
                            return IndexedDB.DbContext.promise(_this.db.transaction("Contract", "readwrite").store("Contract").put({
                    ...
                    IndexedDBWallet.prototype.close = function () {
                        var _this = this;
                        return _super.prototype.close.call(this).then(function () {
                            _this.db.close();
                        });
                    };
                    IndexedDBWallet.create = function (name, password, createAccount) {
                        if (createAccount === void 0) { createAccount = true; }
                        var wallet = new IndexedDBWallet(name);
                        return wallet.db.open().then(function () {
                    ...
                    IndexedDBWallet.prototype.createAccount = function (privateKey) {
                        ...
                        return _super.prototype.createAccount.call(this, privateKey).then(function (result) {
                            ...
                            return GT.Wallets.Contract.createSignatureContract(account.publicKey);
                        }).then(function (result) {
                    ...
                    IndexedDBWallet.delete = function (name) {
                        return IndexedDB.DbContext.delete(name);
                    };
                    ...
                    IndexedDBWallet.prototype.getTransactions = function (type) {
                        var array = new Array();
                        var keyRange = type == null ? null : IDBKeyRange.only(type);
                        var transaction = this.db.transaction("Transaction", "readonly");
                        transaction.store("Transaction").index("type").openCursor(keyRange).onsuccess = function (e) {
                            var cursor = e.target.result;
                            if (cursor) {
                                array.push(GT.Core.Transaction.deserializeFrom(cursor.value.rawData.hexToBytes().buffer));
                                cursor.continue();
                            }
                        };
                        return transaction.commit().then(function () {
                        ...
                        transaction.store("Account").openCursor().onsuccess = function (e) {
                            ...
                            if (cursor) {
                                promises.push(_this.decryptPrivateKey(cursor.value.privateKeyEncrypted.hexToBytes()).then(function (result) {
                                    return GT.Wallets.Account.create(result);
                                }));
                                cursor.continue();
                            }
                        };
                    ...
                    IndexedDBWallet.prototype.loadCoins = function () {
                        ...
                        transaction.store("Coin").openCursor().onsuccess = function (e) {
                            var cursor = e.target.result;
                            if (cursor) {
                                var coin = new GT.Wallets.Coin();
                                coin.input = new GT.Core.TransactionInput();
                                coin.input.prevHash = GT.Uint256.parse(cursor.value.txid);
                                coin.input.prevIndex = cursor.value.index;
                                coin.assetId = GT.Uint256.parse(cursor.value.assetId);
                                coin.value = GT.Fixed8.parse(cursor.value.value);
                                coin.scriptHash = GT.Uint160.parse(cursor.value.scriptHash);
                    ...
                    IndexedDBWallet.prototype.loadContracts = function () {
                        ...
                        transaction.store("Contract").openCursor().onsuccess = function (e) {
                            var cursor = e.target.result;
                            if (cursor) {
                                var contract = new GT.Wallets.Contract();
                                contract.redeemScript = cursor.value.redeemScript.hexToBytes().buffer;
                                contract.parameterList = cursor.value.parameterList;
                                contract.publicKeyHash = GT.Uint160.parse(cursor.value.publicKeyHash);
                                contract.scriptHash = GT.Uint160.parse(cursor.value.scriptHash);
                                array.push(contract);
                                cursor.continue();
                            }
                        };
                    ...
                    IndexedDBWallet.prototype.loadStoredData = function (name) {
                        return IndexedDB.DbContext.promise(this.db.transaction("Key", "readonly").store("Key").get(name)).then(function (result) {
                    ...
                    IndexedDBWallet.prototype.onCoinsChanged = function (transaction, added, changed, deleted) {
                        for (var i = 0; i < added.length; i++) {
                            transaction.store("Coin").add({
                                "txid,index": added[i].input.prevHash.toString() + "_" + added[i].input.prevIndex,
                                ...
                                state: GT.Wallets.CoinState.Unspent
                            });
                        }
                        for (var i = 0; i < changed.length; i++) {
                            transaction.store("Coin").put({
                                "txid,index": changed[i].input.prevHash.toString() + "_" + changed[i].input.prevIndex,
                        ...
                        for (var i = 0; i < deleted.length; i++) {
                            if (transaction.store("Coin").keyPath == "txid,index")
                    ...
                    IndexedDBWallet.prototype.onCreateAccount = function (account) {
                        ...
                        return this.encryptPrivateKey(decryptedPrivateKey).then(function (result) {
                            return IndexedDB.DbContext.promise(_this.db.transaction("Account", "readwrite").store("Account").put({
                    ...
                    IndexedDBWallet.prototype.onProcessNewBlock = function (block, transactions, added, changed, deleted) {
                        ...
                        transaction.store("Transaction").index("height").openCursor(IDBKeyRange.only(-1)).onsuccess = function (e) {
                            var cursor = e.target.result;
                            if (cursor) {
                                for (var i = 0; i < block.transactions.length; i++)
                    ...
                    IndexedDBWallet.prototype.onSaveTransaction = function (tx, added, changed) {
                    ...
                    IndexedDBWallet.open = function (name, password) {
                        var wallet = new IndexedDBWallet(name);
                        return wallet.db.open().then(function (result) {
...
(function (GT) {
    ...
    (function (Core) {
            ...
            Object.defineProperty(Blockchain, "GenesisBlock", {
                get: function () {
                    if (Blockchain._GenesisBlock == null) {
                        Blockchain._GenesisBlock = "".hexToBytes().asSerializable(Core.Block);
                    }
        ...
        Blockchain._MintingAmount = [80, 70, 60, 50, 40, 30, 20, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10];
        Core.Blockchain = Blockchain;
    })(Core = GT.Core || (GT.Core = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    var Implementations;
            ...
            (function (RPC) {
                var RpcBlockchain = (function (_super) {
                    ...
                    function RpcBlockchain(rpc) {
                        var _this = _super.call(this) || this;
                        _this.rpc = rpc;
                        _this.map_block_index = new Map();
                        _this.map_block_hash = new Map();
                        _this.map_tx_hash = new Map();
                        return _this;
                    }
                    RpcBlockchain.prototype.getBestBlockHash = function () {
                        return this.rpc.call("getbestblockhash", []).then(function (result) {
                            return new GT.Uint256(result.hexToBytes().buffer);
                        });
                    };
                    RpcBlockchain.prototype.getBlock = function (hashOrIndex) {
                        ...
                        return this.rpc.call("getblock", [key, false]).then(function (result) {
                            if (map.has(key))
                                return map.get(key);
                            var block = result.hexToBytes().asSerializable(GT.Core.Block);
                    ...
                    RpcBlockchain.prototype.getTransaction = function (hash) {
                        ...
                        return this.rpc.call("getrawtransaction", [key, false]).then(function (result) {
                            ...
                            var tx = GT.Core.Transaction.deserializeFrom(result.hexToBytes().buffer);
...
(function (GT) {
    ...
    })(Cryptography = GT.Cryptography || (GT.Cryptography = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    var Cryptography;
    (function (Cryptography) {
        var Base58 = (function () {
            ...
            Base58.decode = function (input) {
                var bi = GT.BigInteger.Zero;
                for (var i = input.length - 1; i >= 0; i--) {
                    var index = Base58.Alphabet.indexOf(input[i]);
                    if (index == -1)
                        throw new RangeError();
                    bi = GT.BigInteger.add(bi, GT.BigInteger.multiply(GT.BigInteger.pow(Base58.Alphabet.length, input.length - 1 - i), index));
                }
            ...
            Base58.encode = function (input) {
                var value = GT.BigInteger.fromUint8Array(input, 1, false);
                var s = "";
                while (!value.isZero()) {
                    var r = GT.BigInteger.divRem(value, Base58.Alphabet.length);
    ...
    (function (Cryptography) {
        ...
        var ECCurve = (function () {
            ...
            Object.defineProperty(ECCurve, "secp256k1", {
                get: function () {
                    return _secp256k1 || (_secp256k1 = new ECCurve(GT.BigInteger.fromString("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFC2F", 16), GT.BigInteger.Zero, new GT.BigInteger(7), GT.BigInteger.fromString("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEBAAEDCE6AF48A03BBFD25E8CD0364141", 16), ("04" + "79BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798" + "483ADA7726A3C4655DA4FBFC0E1108A8FD17B448A68554199C47D08FFB10D4B8").hexToBytes()));
                },
                enumerable: true,
                configurable: true
            });
            Object.defineProperty(ECCurve, "secp256r1", {
                get: function () {
                    return _secp256r1 || (_secp256r1 = new ECCurve(GT.BigInteger.fromString("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFF", 16), GT.BigInteger.fromString("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC", 16), GT.BigInteger.fromString("5AC635D8AA3A93E7B3EBBD55769886BC651D06B0CC53B0F63BCE3C3E27D2604B", 16), GT.BigInteger.fromString("FFFFFFFF00000000FFFFFFFFFFFFFFFFBCE6FAADA7179E84F3B9CAC2FC632551", 16), ("04" + "6B17D1F2E12C4247F8BCE6E563A440F277037D812DEB33A0F4A13945D898C296" + "4FE342E2FE1A7F9B8EE7EB4A7C0F9E162BCE33576B315ECECBB6406837BF51F5").hexToBytes()));
                },
                enumerable: true,
                configurable: true
            });
    ...
    (function (Cryptography) {
        var ECDsa = (function () {
            ...
            ECDsa.calculateE = function (n, message) {
                return GT.BigInteger.fromUint8Array(new Uint8Array(Cryptography.Sha256.computeHash(message)), 1, false);
            };
            ...
            ECDsa.prototype.sign = function (message) {
                ...
                var d = GT.BigInteger.fromUint8Array(this.key.privateKey, 1, false);
                var r, s;
                do {
                    var k = void 0;
                    do {
                        do {
                            k = GT.BigInteger.random(this.key.publicKey.curve.N.bitLength(), window.crypto);
    ...
    (function (Cryptography) {
        var ECFieldElement = (function () {
            function ECFieldElement(value, curve) {
                this.value = value;
                this.curve = curve;
                if (GT.BigInteger.compare(value, curve.Q) >= 0)
            ...
            ECFieldElement.fastLucasSequence = function (p, P, Q, k) {
                ...
                var Uh = GT.BigInteger.One;
                var Vl = new GT.BigInteger(2);
                var Vh = P;
                var Ql = GT.BigInteger.One;
                var Qh = GT.BigInteger.One;
                for (var j = n - 1; j >= s + 1; --j) {
                    Ql = GT.BigInteger.mod(GT.BigInteger.multiply(Ql, Qh), p);
                    if (k.testBit(j)) {
            ...
            ECFieldElement.prototype.sqrt = function () {
                if (this.curve.Q.testBit(1)) {
                    var z = new ECFieldElement(GT.BigInteger.modPow(this.value, this.curve.Q.rightShift(2).add(1), this.curve.Q), this.curve);
                    return z.square().equals(this) ? z : null;
                }
                var qMinusOne = this.curve.Q.subtract(1);
                var legendreExponent = qMinusOne.rightShift(1);
                if (GT.BigInteger.modPow(this.value, legendreExponent, this.curve.Q).equals(1))
                    return null;
                ...
                do {
                    var P = void 0;
                    do {
                        P = GT.BigInteger.random(this.curve.Q.bitLength());
                    } while (P.compareTo(this.curve.Q) >= 0 || !GT.BigInteger.modPow(P.multiply(P).subtract(fourQ), legendreExponent, this.curve.Q).equals(qMinusOne));
                ...
                } while (U.equals(GT.BigInteger.One) || U.equals(qMinusOne));
                return null;
            };
    ...
    (function (Cryptography) {
        var ECPoint = (function () {
                    ...
                    case 0x03:
                        {
                            ...
                            var X1 = GT.BigInteger.fromUint8Array(encoded.subarray(1), 1, false);
                    ...
                    case 0x07:
                        {
                            ...
                            var X1 = GT.BigInteger.fromUint8Array(encoded.subarray(1, 1 + expectedLength), 1, false);
                            var Y1 = GT.BigInteger.fromUint8Array(encoded.subarray(1 + expectedLength), 1, false);
            ...
            ECPoint.multiply = function (p, n) {
                var k = n instanceof Uint8Array ? GT.BigInteger.fromUint8Array(n, 1, false) : n;
                if (p.isInfinity())
                    return p;
                if (k.isZero())
            ...
            ECPoint.prototype.twice = function () {
                ...
                var TWO = new Cryptography.ECFieldElement(new GT.BigInteger(2), this.curve);
                var THREE = new Cryptography.ECFieldElement(new GT.BigInteger(3), this.curve);
            ...
            ECPoint.windowNaf = function (width, k) {
                ...
                while (k.sign() > 0) {
                    if (!k.isEven()) {
                        var remainder = GT.BigInteger.remainder(k, pow2wB);
                        if (remainder.testBit(width - 1)) {
                            wnaf[i] = GT.BigInteger.subtract(remainder, pow2wB).toInt32();
                        }
                        else {
    ...
    (function (Cryptography) {
        ...
        if (window.crypto.subtle == null && w.msCrypto) {
            window.crypto.subtle = {
                decrypt: function (a, b, c) { return new Promise(function (resolve, reject) { var op = w.msCrypto.subtle.decrypt(a, b, c); op.oncomplete = function () { return resolve(op.result); }; op.onerror = function (e) { return reject(e); }; }); },
                deriveBits: function (a, b, c) { return new Promise(function (resolve, reject) { var op = w.msCrypto.subtle.deriveBits(a, b, c); op.oncomplete = function () { return resolve(op.result); }; op.onerror = function (e) { return reject(e); }; }); },
                deriveKey: function (a, b, c, d, e) { return new Promise(function (resolve, reject) { var op = w.msCrypto.subtle.deriveKey(a, b, c, d, e); op.oncomplete = function () { return resolve(op.result); }; op.onerror = function (e) { return reject(e); }; }); },
                digest: function (a, b) { return new Promise(function (resolve, reject) { var op = w.msCrypto.subtle.digest(a, b); op.oncomplete = function () { return resolve(op.result); }; op.onerror = function (e) { return reject(e); }; }); },
                encrypt: function (a, b, c) { return new Promise(function (resolve, reject) { var op = w.msCrypto.subtle.encrypt(a, b, c); op.oncomplete = function () { return resolve(op.result); }; op.onerror = function (e) { return reject(e); }; }); },
                exportKey: function (a, b) { return new Promise(function (resolve, reject) { var op = w.msCrypto.subtle.exportKey(a, b); op.oncomplete = function () { return resolve(op.result); }; op.onerror = function (e) { return reject(e); }; }); },
                generateKey: function (a, b, c) { return new Promise(function (resolve, reject) { var op = w.msCrypto.subtle.generateKey(a, b, c); op.oncomplete = function () { return resolve(op.result); }; op.onerror = function (e) { return reject(e); }; }); },
                importKey: function (a, b, c, d, e) { return new Promise(function (resolve, reject) { var op = w.msCrypto.subtle.importKey(a, b, c, d, e); op.oncomplete = function () { return resolve(op.result); }; op.onerror = function (e) { return reject(e); }; }); },
                sign: function (a, b, c) { return new Promise(function (resolve, reject) { var op = w.msCrypto.subtle.sign(a, b, c); op.oncomplete = function () { return resolve(op.result); }; op.onerror = function (e) { return reject(e); }; }); },
                unwrapKey: function (a, b, c, d, e, f, g) { return new Promise(function (resolve, reject) { var op = w.msCrypto.subtle.unwrapKey(a, b, c, d, e, f, g); op.oncomplete = function () { return resolve(op.result); }; op.onerror = function (e) { return reject(e); }; }); },
                verify: function (a, b, c, d) { return new Promise(function (resolve, reject) { var op = w.msCrypto.subtle.verify(a, b, c, d); op.oncomplete = function () { return resolve(op.result); }; op.onerror = function (e) { return reject(e); }; }); },
                wrapKey: function (a, b, c, d) { return new Promise(function (resolve, reject) { var op = w.msCrypto.subtle.wrapKey(a, b, c, d); op.oncomplete = function () { return resolve(op.result); }; op.onerror = function (e) { return reject(e); }; }); },
            };
        }
    ...
    (function (Core) {
        var Transaction = (function (_super) {
            ...
            Object.defineProperty(Transaction.prototype, "systemFee", {
                get: function () { return GT.Fixed8.Zero; },
                enumerable: true,
                configurable: true
            });
            ...
            Transaction.deserializeFrom = function () {
                if (arguments[0] instanceof ArrayBuffer) {
                    ...
                    var ms = new GT.IO.MemoryStream(value, offset, value.byteLength - offset, false);
                    var reader = new GT.IO.BinaryReader(ms);
                    ...
                    var typeName = "GT.Core." + Core.TransactionType[type];
                    var t = eval(typeName);
            ...
            Transaction.prototype.setScripts = function (scripts) {
                this.scripts = scripts;
            };
            return Transaction;
        }(GT.Network.Inventory));
    ...
    (function (Core) {
        var AgencyTransaction = (function (_super) {
            ...
            function AgencyTransaction() {
                return _super.call(this, Core.TransactionType.AgencyTransaction) || this;
            }
...
(function (GT) {
    ...
    (function (Core) {
        ...
        })(AssetType = Core.AssetType || (Core.AssetType = {}));
    })(Core = GT.Core || (GT.Core = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    ...
    (function (Core) {
        var Block = (function (_super) {
            ...
            Block.prototype.getScriptHashesForVerifying = function () {
                if (this.prevBlock.equals(GT.Uint256.Zero))
            ...
            Block.prototype.setScripts = function (scripts) {
                if (scripts.length != 1)
                    throw new RangeError();
    ...
    (function (Core) {
        var ClaimTransaction = (function (_super) {
            ...
            function ClaimTransaction() {
                return _super.call(this, Core.TransactionType.ClaimTransaction) || this;
            }
...
(function (GT) {
    ...
    (function (Core) {
        ...
        (function (ContractParameterType) {
            ContractParameterType[ContractParameterType["Signature"] = 0] = "Signature";
            ContractParameterType[ContractParameterType["Boolean"] = 1] = "Boolean";
            ContractParameterType[ContractParameterType["Integer"] = 2] = "Integer";
            ContractParameterType[ContractParameterType["Hash160"] = 3] = "Hash160";
            ContractParameterType[ContractParameterType["Hash256"] = 4] = "Hash256";
            ContractParameterType[ContractParameterType["ByteArray"] = 5] = "ByteArray";
        })(ContractParameterType = Core.ContractParameterType || (Core.ContractParameterType = {}));
    })(Core = GT.Core || (GT.Core = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    ...
    (function (Core) {
        var ContractTransaction = (function (_super) {
            ...
            function ContractTransaction() {
                return _super.call(this, Core.TransactionType.ContractTransaction) || this;
            }
    ...
    (function (Core) {
        var EnrollmentTransaction = (function (_super) {
            ...
            function EnrollmentTransaction() {
                return _super.call(this, Core.TransactionType.EnrollmentTransaction) || this;
            }
            Object.defineProperty(EnrollmentTransaction.prototype, "systemFee", {
                get: function () { return GT.Fixed8.fromNumber(1000); },
                enumerable: true,
                configurable: true
            });
            EnrollmentTransaction.prototype.deserializeExclusiveData = function (reader) {
                this.publicKey = GT.Cryptography.ECPoint.deserializeFrom(reader, GT.Cryptography.ECCurve.secp256r1);
            };
            EnrollmentTransaction.prototype.getScriptHashesForVerifying = function () {
                ...
                return _super.prototype.getScriptHashesForVerifying.call(this).then(function (result) {
                    for (var i = 0; i < result.length; i++)
                        hashes.set(result[i].toString(), result[i]);
                    return GT.Wallets.Contract.createSignatureRedeemScript(_this.publicKey).toScriptHash();
                }).then(function (result) {
...
(function (GT) {
    ...
    (function (Core) {
        var FunctionCode = (function () {
            ...
            Object.defineProperty(FunctionCode.prototype, "ScriptHash", {
                get: function () {
                    var _this = this;
                    if (this.scriptHash == null) {
                        this.script.toScriptHash().then(function (result) {
                            _this.scriptHash = result;
                            return _this.scriptHash;
                        });
                    }
            ...
            Object.defineProperty(FunctionCode.prototype, "Size", {
                get: function () {
                    return this._size;
                },
                enumerable: true,
            ...
            FunctionCode.prototype.deserialize = function (reader) {
                this.script = reader.readVarBytes();
                var paraList = reader.readVarBytes();
                for (var i = 0; i < paraList.length; i++) {
                    this.parameterList.push(paraList[i]);
                }
                this.returnType - reader.readByte();
            };
            FunctionCode.prototype.serialize = function (writer) {
            };
            return FunctionCode;
        }());
        Core.FunctionCode = FunctionCode;
    })(Core = GT.Core || (GT.Core = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    var Core;
    (function (Core) {
        var InvocationTransaction = (function (_super) {
            __extends(InvocationTransaction, _super);
            function InvocationTransaction() {
                return _super.call(this, Core.TransactionType.InvocationTransaction) || this;
            }
            Object.defineProperty(InvocationTransaction.prototype, "Size", {
                get: function () {
                    return this.size;
                },
                enumerable: true,
            ...
            Object.defineProperty(InvocationTransaction.prototype, "NetworkFee", {
                get: function () {
                    return this.gas;
                },
                enumerable: true,
            ...
            InvocationTransaction.prototype.deserializeExclusiveData = function (reader) {
                this.script = reader.readVarBytes(65536);
                if (this.version >= 1) {
                    this.gas = reader.readSerializable(GT.Fixed8);
                    if (this.gas < GT.Fixed8.Zero)
                        throw new Error("格式错误");
                }
                else {
                    this.gas = GT.Fixed8.Zero;
                }
            };
            InvocationTransaction.prototype.serializeExclusiveData = function (writer) {
            };
            return InvocationTransaction;
        }(Core.Transaction));
        Core.InvocationTransaction = InvocationTransaction;
    })(Core = GT.Core || (GT.Core = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    ...
    (function (Core) {
        var IssueTransaction = (function (_super) {
            ...
            function IssueTransaction() {
                return _super.call(this, Core.TransactionType.IssueTransaction) || this;
            }
                ...
                get: function () {
                    for (var i = 0; i < this.outputs.length; i++)
                        if (!this.outputs[i].assetId.equals(Core.Blockchain.AntShare.hash) && !this.outputs[i].assetId.equals(Core.Blockchain.AntCoin.hash))
                            return GT.Fixed8.fromNumber(500);
                    return GT.Fixed8.Zero;
                },
                enumerable: true,
                configurable: true
            });
    ...
    (function (Core) {
        var MinerTransaction = (function (_super) {
            ...
            function MinerTransaction() {
                return _super.call(this, Core.TransactionType.MinerTransaction) || this;
            }
...
(function (GT) {
    ...
    (function (Core) {
        var Order = (function () {
            ...
            Order.prototype.setScripts = function (scripts) {
                this.scripts = scripts;
            };
            return Order;
        }());
...
(function (GT) {
    var Core;
    (function (Core) {
        var PublishTransaction = (function (_super) {
            __extends(PublishTransaction, _super);
            function PublishTransaction() {
                return _super.call(this, Core.TransactionType.PublishTransaction) || this;
            }
            Object.defineProperty(PublishTransaction.prototype, "Size", {
                get: function () {
                    return this.size;
                },
                enumerable: true,
            ...
            PublishTransaction.prototype.deserializeExclusiveData = function (reader) {
                this.code = (reader.readSerializable(Core.FunctionCode));
                if (this.version == 0)
            ...
            PublishTransaction.prototype.serializeExclusiveData = function (writer) {
            };
            return PublishTransaction;
        }(Core.Transaction));
        Core.PublishTransaction = PublishTransaction;
    })(Core = GT.Core || (GT.Core = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
    ...
    (function (Core) {
        var RegisterTransaction = (function (_super) {
            ...
            function RegisterTransaction() {
                return _super.call(this, Core.TransactionType.RegisterTransaction) || this;
            }
            Object.defineProperty(RegisterTransaction.prototype, "systemFee", {
                get: function () {
                    return this.assetType == Core.AssetType.AntShare || this.assetType == Core.AssetType.AntCoin ? GT.Fixed8.Zero : GT.Fixed8.fromNumber(10000);
                },
                enumerable: true,
                configurable: true
            });
            RegisterTransaction.prototype.deserializeExclusiveData = function (reader) {
                ...
                this.issuer = GT.Cryptography.ECPoint.deserializeFrom(reader, GT.Cryptography.ECCurve.secp256r1);
                this.admin = reader.readUint160();
            };
            RegisterTransaction.prototype.getName = function (lang) {
                if (lang === void 0) { lang = navigator.language; }
                var _names;
                try {
                    _names = JSON.parse(this.name);
                }
                catch (ex) {
                    _names = this.name;
                }
            ...
            RegisterTransaction.prototype.getScriptHashesForVerifying = function () {
                ...
                return _super.prototype.getScriptHashesForVerifying.call(this).then(function (result) {
                    for (var i = 0; i < result.length; i++)
                        hashes.set(result[i].toString(), result[i]);
                    return GT.Wallets.Contract.createSignatureRedeemScript(_this.issuer).toScriptHash();
                }).then(function (result) {
                    hashes.set(result.toString(), result);
...
(function (GT) {
    ...
    (function (Core) {
        var SignatureContext = (function () {
                ...
                for (var i = 0; i < this.scriptHashes.length; i++) {
                    if (this.scriptHashes[i].equals(contract.scriptHash)) {
                        ...
                        for (var j = 0; j < contract.parameterList.length && completed; j++)
                            if (contract.parameterList[j] != GT.Wallets.ContractParameterType.Signature)
                                completed = false;
            ...
            SignatureContext.create = function (signable, typeName) {
            ...
            SignatureContext.fromJson = function (json) {
                var t = eval(json["type"]);
                var signable = new t();
                var ms = new GT.IO.MemoryStream(json["hex"].hexToBytes(), false);
                var reader = new GT.IO.BinaryReader(ms);
                signable.deserializeUnsigned(reader);
                return Core.SignatureContext.create(signable, json["type"]).then(function (result) {
                    for (var i = 0; i < json["scripts"].length; i++) {
                        if (json["scripts"][i] != null) {
                            result.redeemScripts[i] = json["scripts"][i]["redeem_script"].hexToBytes();
                            result.signatures[i] = new Map();
                            var sigs = json["scripts"][i]["signatures"];
                            for (var j = 0; j < sigs.length; j++) {
                                var pubkey = GT.Cryptography.ECPoint.decodePoint(sigs[j]["pubkey"].hexToBytes(), GT.Cryptography.ECCurve.secp256r1);
                                var signature = sigs[j]["signature"].hexToBytes();
            ...
            SignatureContext.prototype.getScripts = function () {
                ...
                var _loop_2 = function (i) {
                    ...
                    this_2.signatures[i].forEach(function (signature, key) {
                        array.push({ pubkey: GT.Cryptography.ECPoint.parse(key, GT.Cryptography.ECCurve.secp256r1), signature: signature });
                    });
            ...
            SignatureContext.parse = function (value) {
                return SignatureContext.fromJson(JSON.parse(value));
            };
            SignatureContext.prototype.toJson = function () {
                var json = new Object();
                ...
                var _loop_3 = function (i) {
                    if (this_3.signatures[i] == null) {
                        json["scripts"].push(null);
                    }
                    else {
                        json["scripts"].push(new Object());
                        json["scripts"][i]["redeem_script"] = new Uint8Array(this_3.redeemScripts[i]).toHexString();
                        var sigs_1 = new Array();
                        this_3.signatures[i].forEach(function (value, key) {
                            var signature = new Object();
                            signature["pubkey"] = key;
                            signature["signature"] = new Uint8Array(value).toHexString();
                            sigs_1.push(signature);
                        });
                        json["scripts"][i]["signatures"] = sigs_1;
                        json["scripts"][i]["completed"] = this_3.completed[i];
                    }
                };
                var this_3 = this;
            ...
            SignatureContext.prototype.toString = function () {
    ...
    (function (Core) {
        var TransactionAttribute = (function () {
            ...
            TransactionAttribute.prototype.deserialize = function (reader) {
                ...
                if (this.usage == Core.TransactionAttributeUsage.ContractHash || this.usage == Core.TransactionAttributeUsage.Vote || (this.usage >= Core.TransactionAttributeUsage.Hash1 && this.usage <= Core.TransactionAttributeUsage.Hash15))
...
(function (GT) {
    ...
    (function (Core) {
        ...
        })(TransactionAttributeUsage = Core.TransactionAttributeUsage || (Core.TransactionAttributeUsage = {}));
    })(Core = GT.Core || (GT.Core = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
...
(function (GT) {
    ...
    (function (Core) {
        ...
        })(TransactionType = Core.TransactionType || (Core.TransactionType = {}));
    })(Core = GT.Core || (GT.Core = {}));
})(GT || (GT = {}));
var GT;
(function (GT) {
            ...
            var ScriptBuilder = (function () {
                ...
                ScriptBuilder.prototype.push = function (data) {
                    ...
                    if (typeof data === "number") {
                        ...
                        return this.push(new GT.BigInteger(data).toUint8Array());
                    }
                    else {
                        var buffer = data;
...
(function (GT) {
    var Betting = (function () {
        function Betting(AMT, BetPoint, RoomID, BizHeight, Timestamp) {
            this.AMT = AMT;
            this.BetPoint = BetPoint;
            this.RoomID = RoomID;
            this.BizHeight = BizHeight;
            this.Timestamp = Timestamp;
        }
        Betting.prototype.serializeUnsigned = function (writer) {
            writer.writeFixed8(this.AMT);
            writer.writeVarString(this.BetPoint);
            writer.writeUint32(this.RoomID);
            writer.writeUint32(this.BizHeight);
            writer.writeUint32(this.Timestamp);
        };
        return Betting;
    }());
...
(function (GT) {
    var Global = (function () {
        ...
        Global.GetApi = function (url) {
            return new GT.Network.REST.SPVClient(url);
        };
        Global.IsLogined = function () {
            return Global.Wallet != null;
        };
        return Global;
    }());
    Global.reConnectMultiplier = 15;
    GT.Global = Global;
})(GT || (GT = {}));
var GT;
(function (GT) {
    var Revoke = (function () {
        function Revoke(RoomID, BizHeight, Timestamp) {
            this.RoomID = RoomID;
            this.BizHeight = BizHeight;
            this.Timestamp = Timestamp;
        }
        Revoke.prototype.serializeUnsigned = function (writer) {
            writer.writeUint32(this.RoomID);
            writer.writeUint32(this.BizHeight);
            writer.writeUint32(this.Timestamp);
        };
...
(function (GT) {
    ...
    (function (Wallets) {
        var Master = (function (_super) {
            ...
            function Master() {
                return _super.call(this, "master") || this;
            }
            Master.prototype.add = function (name) {
                return GT.Implementations.Wallets.IndexedDB.DbContext.promise(this.transaction("Wallet", "readwrite").store("Wallet").put({ name: name }));
            };
            Master.prototype.clear = function () {
                return GT.Implementations.Wallets.IndexedDB.DbContext.promise(this.transaction("Wallet", "readwrite").store("Wallet").clear());
            };
            Master.prototype.delete = function (name) {
                return GT.Implementations.Wallets.IndexedDB.DbContext.promise(this.transaction("Wallet", "readwrite").store("Wallet").delete(name));
            };
            Master.prototype.get = function () {
                var array = new Array();
                var transaction = this.transaction("Wallet", "readwrite");
                transaction.store("Wallet").openCursor().onsuccess = function (e) {
                    var cursor = e.target.result;
                    if (cursor) {
            ...
            Master.instance = function () {
                if (Master.singleton == null) {
                    ...
                    return Master.singleton.open().then(function () {
            ...
            Master.prototype.onModelCreating = function (db) {
                db.createObjectStore("Wallet", { keyPath: "name" });
            };
            return Master;
        }(GT.Implementations.Wallets.IndexedDB.DbContext));
    ...
    (function (UI) {
        ...
        (function (Contacts) {
            var Contact = (function (_super) {
                ...
                function Contact() {
                    return _super.call(this, "contacts") || this;
                }
                Contact.prototype.add = function (name, address) {
                    return GT.Implementations.Wallets.IndexedDB.DbContext.promise(this.transaction("Contacts", "readwrite").store("Contacts").put({ name: name, address: address }));
                };
                Contact.prototype.clear = function () {
                    return GT.Implementations.Wallets.IndexedDB.DbContext.promise(this.transaction("Contacts", "readwrite").store("Contacts").clear());
                };
                Contact.prototype.delete = function (name) {
                    return GT.Implementations.Wallets.IndexedDB.DbContext.promise(this.transaction("Contacts", "readwrite").store("Contacts").delete(name));
                };
                Contact.prototype.get = function () {
                    var array = new Array();
                    var transaction = this.transaction("Contacts", "readwrite");
                    transaction.store("Contacts").openCursor().onsuccess = function (e) {
                        var cursor = e.target.result;
                        if (cursor) {
                            array.push(cursor.key);
                            cursor.continue();
                ...
                Contact.instance = function () {
                    if (Contact.singleton == null) {
                        ...
                        return Contact.singleton.open().then(function () {
                ...
                Contact.prototype.onModelCreating = function (db) {
                    db.createObjectStore("Contacts", { keyPath: "name" });
                };
                return Contact;
            }(GT.Implementations.Wallets.IndexedDB.DbContext));
            Contacts.Contact = Contact;
        })(Contacts = UI.Contacts || (UI.Contacts = {}));
    })(UI = GT.UI || (GT.UI = {}));
})(GT || (GT = {}));
